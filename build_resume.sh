...
pandoc ./pandoc/resume.md -o ./static/resume.pdf --from markdown+smart --template ./pandoc/resume.latex --pdf-engine=xelatex --pdf-engine-opt=--shell-escape --metadata-file=./src/lib/content/work-experience.yaml --metadata-file=./pandoc/languages.yaml --metadata-file=./pandoc/github-repos.yaml
